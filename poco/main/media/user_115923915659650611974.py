...
try:
	# choice of feeder: titanic_starter_table
        # choice of dropbox name: row
        # feeder: for row in titanic_starter_table
        # factory: row['Age']
        # filter: row['Sex']
        
        average_female_ages = [row['Age'] for row in titanic_starter_table if row['Sex'] == 'female']  
