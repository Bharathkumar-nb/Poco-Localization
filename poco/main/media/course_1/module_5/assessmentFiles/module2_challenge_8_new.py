...
average_name_length = sum_all_names/len(len_all_names)
'''
...
if not isinstance(average_name_length, int):
...
try:
	...
	check = (average_name_length == xsum_all_names/len(xlen_all_names))
except Exception as e:
	report('Generic error', 'On your own', e)
else:
	if not check:
