...
xpa_yes = [xpa_converter(row) for row in loan_table if row['Loan_Status'] == 'Y']
xpa_no = [xpa_converter(row) for row in loan_table if row['Loan_Status'] == 'N']    
