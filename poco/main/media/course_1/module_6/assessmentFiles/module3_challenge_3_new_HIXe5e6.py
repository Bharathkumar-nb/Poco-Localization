...
expensive_table = [row for row in titanic_starter_table if row['Fare']>30]
...
if len(expensive_class1_table) != 1:
	report('Length bug', 'expensive_class1_table should have length of 1 but has length ' + str(len(expensive_class1_table)), 'No further help available')
	sys.exit(1)
