...
# target_url2 = '/home/poco/waggle-classroom/main/media/tmp/attempt_4_7_{}.png'.format(datetime.now())

target_url1 = os.path.join(settings.BASE_DIR, "main", "media", "course_1", "module_7","image_7","challenge7.png")
target_url2 = os.path.join(settings.BASE_DIR, "main", "media", "tmp", "attempt_4_7_{}.png".format(datetime.now()))
