...
# target_url1 = '/home/poco/waggle-classroom/main/media/course_1/module_9/image_5/challenge7.png'
# target_url2 = '/home/poco/waggle-classroom/main/media/tmp/attempt_6_5_{}.png'.format(datetime.now())

target_url1 = os.path.join(settings.BASE_DIR, "main", "media", "course_1", "module_9","image_5","challenge7.png")
target_url2 = os.path.join(settings.BASE_DIR, "main", "media", "tmp", "attempt_6_5_{}.png".format(datetime.now()))
