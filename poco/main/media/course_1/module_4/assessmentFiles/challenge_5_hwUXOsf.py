...
try:
	...
	if not check:
		report('Value bug', 'Wrong value for "One" of ' + str(repr(dict_practice['One'])) + ' which is incorrect')
...
try:
	...
	if not check:
		report('Value bug', 'Wrong value for "Two" of ' + str(repr(dict_practice['Two'])) + ' which is incorrect')
...
try:
	...
	if not check:
		report('Value bug', 'Wrong value for "Three"', 'value of "Three" is ' + str(repr(dict_practice['Three'])) + ' which is incorrect')