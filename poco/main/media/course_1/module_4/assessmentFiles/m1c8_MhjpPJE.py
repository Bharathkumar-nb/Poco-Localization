...
if sorted(row0.values()) != sorted(xrow0.values()):
	report('Value bug', 'row0 values do not match ' + str(xrow0.values()), 'No further help available')
	sys.exit(1)
...
if sorted(row1.values()) != sorted(xrow1.values()):
	report('Value bug', 'row1 values do not match ' + str(xrow1.values()), 'No further help available')
	sys.exit(1)
...
if sorted(row2.values()) != sorted(xrow2.values()):
	report('Value bug', 'row2 values do not match ' + str(xrow2.values()), 'No further help available')
	sys.exit(1)	
...
if len(crime_table) > len(xcrime):
	report('Length bug', 'crime_table has extra key-values ', 'No further help available')
	sys.exit(1)

if len(crime_table) < len(xcrime):
	report('Length bug', 'crime_table is missing extra key-values ', 'No further help available')
	sys.exit(1)
